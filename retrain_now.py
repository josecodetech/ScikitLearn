#!/usr/bin/env python3
"""
IMMEDIATE FIX: Run this script BEFORE restarting the FastAPI server
This will retrain the model with the current scikit-learn 1.8.0
"""
...
print("\n" + "="*70)
print("RETRAINING TITANIC MODEL FOR SCIKIT-LEARN 1.8.0 COMPATIBILITY")
print("="*70 + "\n")
...
joblib.dump(pipeline_titanic, model_path)
...
print("="*70)
print("\nNext steps:")
print("1. If FastAPI is running, stop it (Ctrl+C)")
print("2. Restart the FastAPI server")
print("3. Try your prediction again!")
print("\n")
